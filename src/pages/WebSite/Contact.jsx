...
function ContactUs() {
    ...
    return (
        <>
            <div className="min-h-screen bg-black pt-24 pb-16 px-6 lg:pl-32 lg:pr-10 text-white">
                            ...
                            <div>
                                ...
                                <div className="space-y-8">
                                    <div className="group">
                                        ...
                                        <p className="text-lg font-black tracking-tight group-hover:pl-2 transition-all duration-300">01116045357</p>
                                    </div>
                                    <div className="group">
                                        <p className="text-[9px] font-bold opacity-20 uppercase mb-1">Official Mail</p>
                                        <p className="text-lg font-black tracking-tight group-hover:pl-2 transition-all duration-300 uppercase">abdulrhman@elvora.com</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form ref={form} onSubmit={sendEmail} className="space-y-12">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                    <div className="group border-b border-white/10 focus-within:border-white transition-all py-3">
                                        ...
                                        <input type="text" name="from_name" required className="w-full bg-transparent outline-none text-xs font-bold tracking-widest uppercase" placeholder="ENTER NAME" />
                                    </div>
                                    <div className="group border-b border-white/10 focus-within:border-white transition-all py-3">
                                        <label className="text-[9px] font-black opacity-30 uppercase tracking-widest block mb-2">02. Phone Number</label>
                                        <input type="tel" name="phone" required className="w-full bg-transparent outline-none text-xs font-bold tracking-widest" placeholder="+20 000 000 000" />
                                    </div>
                                </div>

                                <div className="group border-b border-white/10 focus-within:border-white transition-all py-3">
                                    <label className="text-[9px] font-black opacity-30 uppercase tracking-widest block mb-2">03. Email Address</label>
                                    <input type="email" name="from_email" required className="w-full bg-transparent outline-none text-xs font-bold tracking-widest" placeholder="YOUR@EMAIL.COM" />
                                </div>
                                ...
                                <div className="group">
                                    ...
                                    <textarea name="message" rows="4" required className="w-full bg-white/[0.01] border border-white/5 p-6 outline-none focus:border-white/20 text-xs font-medium tracking-widest uppercase transition-all" placeholder="Tell us more about your request..."></textarea>
                                </div>

                                <div className="flex justify-end pt-6">
                                    <button type="submit" className="group bg-white text-black px-14 py-6 text-[10px] font-black uppercase tracking-[0.6em] border border-white hover:bg-black hover:text-white transition-all duration-700 flex items-center gap-6">
                                        Initialize Transmission <FiSend className="group-hover:translate-x-2 transition-transform duration-500" />
                                    </button>
                                </div>
                            </form>
                    </div>
